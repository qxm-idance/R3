...
new Vue({
  ...
  created () {
    new FineUploder.FineUploaderBasic({
      ...
      thumbnails: {
        placeholders: {
          waitingPath: '/examples/fine-upload-demo/placeholders/waiting-generic.png',
          notAvailablePath: '/examples/fine-upload-demo/placeholders/not_available-generic.png'
        }
      },
      validation: {
